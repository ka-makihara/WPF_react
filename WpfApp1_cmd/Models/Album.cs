...
namespace WpfApp1_cmd.Models
{
    public class Album : ViewModelBase
    {
        ...
        {
            get => this._genre;
            set => this.SetProperty(ref this._genre, value);
        }
    ...
    public static class SampleData
    {
        ...
        public static void Seed()
        {
            ...
            Artists = new List<Artist>
                      {
                          new Artist { Name = "PALETTE", Version = "V1.000" },
                          new Artist { Name = "FEEDER", Version = "V1.001" },
                          new Artist { Name = "MRIO", Version = "V1.002" },
                          new Artist { Name = "HEAD", Version = "V1.003" },
                          new Artist { Name = "EEE", Version = "V1.004" },
                          new Artist { Name = "BRIO", Version = "V1.005" },
                          new Artist { Name = "GGG", Version = "V1.006" },
                          new Artist { Name = "HHH", Version = "V1.007" },
                          new Artist { Name = "III", Version = "V1.008"},
						  /*
            ...
            Albums = new List<Album>
                     {
                         new Album { Title = "Palette",        ChkVisibled = false, Genre = Genres.First(g => g.Name == "Rock"), Price = 8.99M, Artist = Artists.First(a => a.Name == "PALETTE"), AlbumArtUrl = "/Content/Images/placeholder.gif" },
                         new Album { Title = "Palette_FPGA",   ChkVisibled = false, Genre = Genres.First(g => g.Name == "Rock"), Price = 8.99M, Artist = Artists.First(a => a.Name == "PALETTE"), AlbumArtUrl = "/Content/Images/placeholder.gif" },
                         new Album { Title = "Feeder",         ChkVisibled = true, Genre = Genres.First(g => g.Name == "Rock"), Price = 8.99M, Artist = Artists.First(a => a.Name == "FEEDER"), AlbumArtUrl = "/Content/Images/placeholder.gif" },
                         new Album { Title = "Feeder_FPGA",    ChkVisibled = true, Genre = Genres.First(g => g.Name == "Rock"), Price = 8.99M, Artist = Artists.First(a => a.Name == "FEEDER"), AlbumArtUrl = "/Content/Images/placeholder.gif" },
                         new Album { Title = "MRemoteIO",      ChkVisibled = true, Genre = Genres.First(g => g.Name == "Jazz"), Price = 8.99M, Artist = Artists.First(a => a.Name == "MRIO"), AlbumArtUrl = "/Content/Images/placeholder.gif" },
                         new Album { Title = "MRemoteIO_FPGA", ChkVisibled = true, Genre = Genres.First(g => g.Name == "Jazz"), Price = 8.99M, Artist = Artists.First(a => a.Name == "MRIO"), AlbumArtUrl = "/Content/Images/placeholder.gif" },
                         new Album { Title = "Head",           ChkVisibled = true, Genre = Genres.First(g => g.Name == "Rock"), Price = 8.99M, Artist = Artists.First(a => a.Name == "HEAD"), AlbumArtUrl = "/Content/Images/placeholder.gif" },
                         new Album { Title = "Head_Servo",     ChkVisibled = true, Genre = Genres.First(g => g.Name == "Rock"), Price = 8.99M, Artist = Artists.First(a => a.Name == "HEAD"), AlbumArtUrl = "/Content/Images/placeholder.gif" },
                         new Album { Title = "BRemoteIO",      ChkVisibled = true, Genre = Genres.First(g => g.Name == "Rock"), Price = 8.99M, Artist = Artists.First(a => a.Name == "BRIO"), AlbumArtUrl = "/Content/Images/placeholder.gif" },
                         new Album { Title = "BRemoteIO_FPGA", ChkVisibled = true, Genre = Genres.First(g => g.Name == "Rock"), Price = 8.99M, Artist = Artists.First(a => a.Name == "BRIO"), AlbumArtUrl = "/Content/Images/placeholder.gif" },
                      /*
